...
async function main() {
  ...
  const catContemporary = await prisma.category.create({
    data: {
      name: "Contemporary Luxury",
      slug: "contemporary-luxury",
      description: "Modern silk column dresses, Indo-western evening ensembles, and tailored luxury jackets crafted from heritage Indian textiles.",
      imageUrl: "/products/contemporary_banarasi_dress.jpg",
    },
  });
  ...
  const productsData = [
    ...
    },
    {
      ...
      description:
        "A sculptural, floor-length column dress cut from handwoven Varanasi silk brocade with subtle geometric antique gold zari, architectural back slit, and pure crepe lining.",
      story:
        "Bridging centuries of Varanasi pit-loom heritage with sleek modern occasionwear, woven by master weavers exclusively for contemporary evening celebrations.",
      fabric: "Pure Mulberry Silk Brocade with Tested Gold Zari",
      basePrice: 19800,
      categoryId: catContemporary.id,
      featured: true,
      images: [
        {
          url: "/products/contemporary_banarasi_dress.jpg",
          altText: "Aria Banarasi Silk Column Dress in Obsidian Gold",
          color: "Obsidian Gold",
          order: 0,
          isPrimary: true,
        },
      ...
      variants: [
        { color: "Obsidian Gold", colorHex: "#1B1813", size: "XS", sku: "ZR-ACD-OBG-XS", stock: 3 },
        { color: "Obsidian Gold", colorHex: "#1B1813", size: "S", sku: "ZR-ACD-OBG-S", stock: 5 },
        { color: "Obsidian Gold", colorHex: "#1B1813", size: "M", sku: "ZR-ACD-OBG-M", stock: 4 },
        { color: "Obsidian Gold", colorHex: "#1B1813", size: "L", sku: "ZR-ACD-OBG-L", stock: 2 },
        { color: "Midnight Emerald", colorHex: "#0C281E", size: "S", sku: "ZR-ACD-EMR-S", stock: 3 },
        { color: "Midnight Emerald", colorHex: "#0C281E", size: "M", sku: "ZR-ACD-EMR-M", stock: 4 },
        { color: "Midnight Emerald", colorHex: "#0C281E", size: "L", sku: "ZR-ACD-EMR-L", stock: 2 },
      ],
    },
    {
    ...
    {
      name: "The Ruhani Embroidered Silk Jacket",
      slug: "ruhani-embroidered-silk-jacket",
      description:
        "A structured statement evening blazer tailored from textured raw Matka silk, adorned with monochrome antique gold zardozi along the peaked lapels, defined shoulders, and hand-cast buttons.",
      story:
        "Each lapel is framed with intricate bullion metallic wire couching by master zardozi karigars, reinterpreting ceremonial court jackets into an empowered modern silhouette.",
      fabric: "Structured Matka Raw Silk with Satin Twill Lining & Zardozi",
      basePrice: 22500,
      categoryId: catContemporary.id,
      featured: true,
      images: [
        {
          url: "/products/contemporary_silk_jacket.jpg",
          altText: "Ruhani Embroidered Silk Jacket in Antique Ivory",
          color: "Antique Ivory",
          order: 0,
          isPrimary: true,
        },
      ...
      variants: [
        { color: "Antique Ivory", colorHex: "#F5F2EB", size: "XS", sku: "ZR-RSJ-IVR-XS", stock: 3 },
        { color: "Antique Ivory", colorHex: "#F5F2EB", size: "S", sku: "ZR-RSJ-IVR-S", stock: 5 },
        { color: "Antique Ivory", colorHex: "#F5F2EB", size: "M", sku: "ZR-RSJ-IVR-M", stock: 4 },
        { color: "Antique Ivory", colorHex: "#F5F2EB", size: "L", sku: "ZR-RSJ-IVR-L", stock: 2 },
        { color: "Imperial Black", colorHex: "#141414", size: "S", sku: "ZR-RSJ-BLK-S", stock: 3 },
        { color: "Imperial Black", colorHex: "#141414", size: "M", sku: "ZR-RSJ-BLK-M", stock: 3 },
        { color: "Imperial Black", colorHex: "#141414", size: "L", sku: "ZR-RSJ-BLK-L", stock: 1 },
      ],
    },
    {
      name: "The Zoya Metallic Tissue Silk Co-ord",
      slug: "zoya-metallic-tissue-silk-coord",
      description:
        "A radiant two-piece occasion ensemble featuring a fluid wrap-front halter top and tailored high-waisted wide-leg palazzo trousers, cut from iridescent copper-gold tissue silk.",
      story:
        "Engineered for effortless evening gala wear, combining the fluidity of Indian tissue silk with crisp, contemporary tailoring lines.",
      fabric: "Liquid Copper-Gold Tissue Silk with Habotai Silk Lining",
      basePrice: 16800,
      categoryId: catContemporary.id,
      featured: false,
      images: [
        {
          url: "/products/contemporary_tissue_coord.jpg",
          altText: "Zoya Metallic Tissue Silk Co-ord in Copper Gold",
          color: "Copper Gold",
          order: 0,
          isPrimary: true,
        },
      ...
      variants: [
        { color: "Copper Gold", colorHex: "#C89550", size: "XS", sku: "ZR-ZTC-COP-XS", stock: 4 },
        { color: "Copper Gold", colorHex: "#C89550", size: "S", sku: "ZR-ZTC-COP-S", stock: 5 },
        { color: "Copper Gold", colorHex: "#C89550", size: "M", sku: "ZR-ZTC-COP-M", stock: 4 },
        { color: "Copper Gold", colorHex: "#C89550", size: "L", sku: "ZR-ZTC-COP-L", stock: 2 },
        { color: "Rose Champagne", colorHex: "#D4AF9A", size: "S", sku: "ZR-ZTC-CHP-S", stock: 3 },
        { color: "Rose Champagne", colorHex: "#D4AF9A", size: "M", sku: "ZR-ZTC-CHP-M", stock: 3 },
        { color: "Rose Champagne", colorHex: "#D4AF9A", size: "L", sku: "ZR-ZTC-CHP-L", stock: 2 },
      ],
    },
  ];
