...
export const CATEGORY_SHADE_MAP: Record<string, Record<string, string>> = {
  ...
  contemporary: {
    black: "/products/contemporary_banarasi_dress.jpg",
    obsidian: "/products/contemporary_banarasi_dress.jpg",
    emerald: "/products/contemporary_banarasi_dress.jpg",
    ivory: "/products/contemporary_silk_jacket.jpg",
    cream: "/products/contemporary_silk_jacket.jpg",
    copper: "/products/contemporary_tissue_coord.jpg",
    gold: "/products/contemporary_tissue_coord.jpg",
    champagne: "/products/contemporary_tissue_coord.jpg",
    rose: "/products/contemporary_tissue_coord.jpg",
  },
  "contemporary-luxury": {
    black: "/products/contemporary_banarasi_dress.jpg",
    obsidian: "/products/contemporary_banarasi_dress.jpg",
