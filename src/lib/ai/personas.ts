...
export const STYLE_PERSONAS: StylePersona[] = [
  ...
  },
  {
    ...
    favoredCategories: ["Heritage Sarees", "Contemporary Luxury", "heritage-sarees", "contemporary-luxury"],
  ...
  },
  {
    ...
    tagline: "Modern silhouettes blending Indian heritage textiles with cosmopolitan glamour.",
    description: "Drawn to sculptural Banarasi column dresses, tailored raw silk evening jackets, and liquid tissue co-ords.",
    badge: "✨ Contemporary Muse",
    favoredCategories: ["Contemporary Luxury", "Festive Pret", "contemporary-luxury", "festive-pret"],
    favoredColors: ["obsidian gold", "copper", "antique ivory", "midnight emerald", "rose champagne"],
    biasKeywords: ["column dress", "jacket", "coord", "dress", "contemporary", "modern", "western"],
  },
];
